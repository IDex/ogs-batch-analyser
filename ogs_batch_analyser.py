...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        help=
        'User id of the user whose games you want to download (example: 123456)'
    )
    parser.add_argument(
        '--number',
        '-n',
    ...
    parser.add_argument(
        ...
        '-o',
        help=
        'Start downloading from the oldest game (by default downloads from latest)',
        action='store_false')
    parser.add_argument(
        '--download-only',
        '-d',
    ...
    parser.add_argument(
        ...
        action='store_true')
    parser.add_argument(
        '--command', '-c', help='Command for the tool used for the analysis')
